...
6. **Settings** (built in M5, layout decided via grill interview 2026-07-14). Third tab; a **left sidebar** selects one of six sections: Insurances, Secondary coverages, Refill notes, Call notes, Thresholds, Backup & restore. All edits persist immediately and trigger an app-wide lookup reload (below).
